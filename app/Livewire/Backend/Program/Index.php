...
namespace App\Livewire\Backend\Program;
...
class Index extends Component
{
    ...
    public function programStored($program)
    {
        ...
        $this->dispatch('swal:modal', [
            ...
            'timer'=>5000,
            'icon'=>'success',
            'text'=>'Pemission ' . $program['name'] . ' was Stored',
    ...
    public function programUpdated($program)
    {
        ...
        $this->dispatch('swal:modal', [
            ...
            'timer'=>5000,
            'icon'=>'success',
            'text'=>'Program ' . $program['name'] . ' was Updated',
            // 'toast'=>true, // Jika mau menggunakan toas
            // 'position'=>'top-right', // Jika mau menggunakan toas
            'showConfirmButton'=>true,
            'showCancelButton'=>false,
    ...
    public function changeDraft()
    {
        ...
        return redirect()->to('backend/allprograms');
    }
    ...
    {
        return view('livewire.backend.program.index',[
