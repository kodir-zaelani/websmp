...
class Index extends Component
{
    ...
    public function store()
    {
        ...
        $this->cleanVars();
        return redirect()->to('backend/menu')->with(['success' => 'Data Menu ' . $menu['name'] . ' was Create successfully']);
     ...
     public function edit($menuID)
    {
        ...
        $model = Menu::find($this->editMenuId);
    ...
    public function update()
    {
        ...
        $this->cleanVars();
        $this->statusUpdate = false;
        return redirect()->to('backend/menu')->with(['warning' => 'Data Menu ' . $menu['name'] . ' was Updated successfully']);
    }
    ...
    public function getMenucategoryQueryProperty()
    {
        ...
        return Menu::orderBy($this->sortColumn, $this->sortDirection)
    ...
    {
        Menu::destroy($this->selectedItem);
    ...
    public function changeInactive()
    {
       ...
       $post = Menu::find($this->selectedItem);
    ...
    {
        dd($this->menucategory);
        return view('livewire.backend.menu.index',[
            'datamenu' => $this->menucategory,
            'title_page'=> 'Menu Postion'
        ]);
    }
}