                ...
                <div class="form-group">
                    ...
                    <div class="demo-radio-button in-line">
                        @foreach ($menus as $item)
                            ...
                            <label for="radio_{{ $item->id }}">{{ $item->title }}</label>
                        @endforeach
                    </div>
                </div>
                <div class="form-group">
                    <label class="form-label">Type Menu :</label>
                    <select class="form-control select2" style="width: 100%;" wire:model="type" required>
                ...
                @elseif ($type == 3)
                    <div class="form-group @error('link') has-error @enderror">
                        ...
                        <div class="form-control-feedback"><small
                                class="text-primary">{{ $prevlink }}</small></div>
                        @error('link')
                            <span class="help-block"><strong>{{ $message }}</strong></span>
                        @enderror
                    </div>
