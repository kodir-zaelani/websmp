                                ...
                                <div class="form-group">
                                    ...
                                    <div class="flexbox">
                                        <div class="flex-grow text-end">
                                            <button class="btn btn-sm btn-primary" wire:click='store'><i class="ti-save"></i> Save</button>
                                            <a href="{{ route('backend.menuitem.index') }}" class="btn btn-sm btn-secondary ms-2">Cancel</a>
                                        </div>
                                    </div>
                                </form>
                            </div>
