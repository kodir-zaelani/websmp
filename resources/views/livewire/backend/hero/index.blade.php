                ...
                <div class="d-inline-block align-items-center">
                    <nav>
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item" aria-current="page">Heros</li>
            ...
            <div class="col-xl-12 col-md-12 col-lg-12 col-12">
                <div class="box box-bordered border-primary">
                    <div class="box-header with-border">
                        ...
                        <a  href="{{ route('backend.heros.create') }}" class="btn btn-success btn-sm ms-3" title="Add New"> <i class="fa fa-plus me-2" aria-hidden="true"></i> Add</a>
                            ...
                            <div class="col-xl-12 col-md-12 col-lg-12 col-12">
                                ...
                                <div class="table-responsive">
                                    <table class="table mb-0 table-hover">
                                        ...
                                        <tbody>
                                            @foreach ($datahero as $no =>  $item)
                                            <tr class="@if ($this->isChecked($item->id))
                                                table-primary
                                                @endif">
                                                <th class="text-right" scope="row">{{ $no + $datahero->firstItem() }}</th>
                                                <td width="10%">
                                                    <img class="rounded avatar avatar-lg bg-success-light"  src="{{ ($item->imageheroThumbUrl) ? $item->imageheroThumbUrl : '/assets/images/avatar/avatar-4.png' }}"  alt="{{ $item->name }}" title="{{ $item->name }}" >
                                                </td>
                                                <td>
                                                ...
                                                <td class="text-center align-midle">
                                                    ...
                                                    @endif
                                                    @endif
                                                    <a href="{{ route('backend.heros.edit', $item->id) }}" class="btn btn-xs btn-warning">
                                ...
                                <div class="mt-3 row">
                                    @if ($datahero->total() > 10)
                                    <div class="col-12 ">
                                        {{ $datahero->links() }}
                                    </div>
                                    @else
                                    <div class="col-12 text-start small text-muted">
                                        Page : {{ $datahero->currentPage() }} | Show {{ $datahero->count() }} data
                                        of {{ $datahero->total() }}
                                    </div>
                                    @endif
                                </div>
