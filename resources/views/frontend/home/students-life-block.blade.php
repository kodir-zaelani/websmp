        ...
        <div class="mb-5 row align-items-center g-5">
            <div class="col-lg-5" data-aos="fade-right" data-aos-delay="200">
                <div class="hero-image-wrapper">
                    <img src="{{ asset('') }}assets/frontend/img/education/students-7.webp" alt="Student Life" class="img-fluid main-image">
                ...
                <div class="col-lg-8" data-aos="fade-right" data-aos-delay="200">
                    <div class="featured-activity">
                        <div class="activity-media">
                            <img src="{{ asset('') }}assets/frontend/img/education/activities-2.webp" alt="Featured Activity" class="img-fluid">
                ...
                <div class="col-lg-4" data-aos="fade-left" data-aos-delay="300">
                    <div class="activities-list">
                        ...
                        <div class="activity-item" data-aos="slide-up" data-aos-delay="400">
                            <div class="activity-thumb">
                                <img src="{{ asset('') }}assets/frontend/img/education/activities-1.webp" alt="Community Service" class="img-fluid">
                            </div>
                            <div class="activity-info">
                        ...
                        <div class="activity-item" data-aos="slide-up" data-aos-delay="450">
                            <div class="activity-thumb">
                                <img src="{{ asset('') }}assets/frontend/img/education/activities-4.webp" alt="Innovation Labs" class="img-fluid">
                            </div>
                            <div class="activity-info">
