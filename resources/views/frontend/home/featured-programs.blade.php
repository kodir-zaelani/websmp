            ...
            <div class="col-lg-6" data-aos="fade-right" data-aos-delay="100">
                <div class="program-banner">
                    <div class="banner-image">
                        <img src="{{ asset('') }}assets/frontend/img/education/campus-3.webp" alt="Program" class="img-fluid">
                    ...
                    <div class="row g-3">
                        <div class="col-12" data-aos="fade-left" data-aos-delay="200">
                            <div class="program-item">
                                <div class="item-icon">
                                    <img src="{{ asset('') }}assets/frontend/img/education/education-4.webp" alt="Program" class="img-fluid">
                                </div>
                        ...
                        <div class="col-12" data-aos="fade-left" data-aos-delay="300">
                            <div class="program-item">
                                <div class="item-icon">
                                    <img src="{{ asset('') }}assets/frontend/img/education/education-6.webp" alt="Program" class="img-fluid">
                                </div>
                                <div class="item-content">
                        ...
                        <div class="col-12" data-aos="fade-left" data-aos-delay="400">
                            <div class="program-item">
                                <div class="item-icon">
                                    <img src="{{ asset('') }}assets/frontend/img/education/education-8.webp" alt="Program" class="img-fluid">
                                </div>
                                <div class="item-content">
                        ...
                        <div class="col-12" data-aos="fade-left" data-aos-delay="500">
                            <div class="program-item">
                                <div class="item-icon">
                                    <img src="{{ asset('') }}assets/frontend/img/education/education-10.webp" alt="Program" class="img-fluid">
                                </div>
                                <div class="item-content">
                                    <h4>Creative Arts</h4>
