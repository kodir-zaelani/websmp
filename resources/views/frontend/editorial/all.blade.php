                    ...
                    <div class="col-md-6">
                        <article class="secondary-post" data-aos="fade-up">
                            ...
                            <div class="post-content">
                                ...
                                <h3 class="post-title">
                                    <a href="{{route('editorial.detail', $item->slug)}}">{{$item->title}}</a>
                                </h3>
                ...
                <div class="news-tabs" data-aos="fade-up" data-aos-delay="200">
                    <ul class="nav nav-tabs" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active" data-bs-toggle="tab" data-bs-target="#trending" type="button">Blog</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link " data-bs-toggle="tab" data-bs-target="#top-stories" type="button">Berita Populer</button>
                        </li>
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade " id="top-stories">
