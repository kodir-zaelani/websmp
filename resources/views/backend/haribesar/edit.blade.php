...
<div class="content-header">
    <div class="d-flex align-items-center">
                    ...
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('backend.dashboard') }}"><i class="fa fa-home"><span
                            ...
                            <li class="breadcrumb-item" aria-current="page"><a
                                href="{{ route('backend.haribesar.index') }}">All Hari Besar</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Edit a haribesar</li>
                            </ol>
                        </nav>
                    </div>
                </div>
        ...
        <section class="content">
            <form id="post-form" enctype="multipart/form-data" action="{{ route('backend.haribesar.update', $haribesar) }}"
            method="POST">
            @csrf
            @method('PUT')
            <div class="row">
                <div class="col-lg-8 col-12">
                    <div class="box">
                        <div class="box-header">
                            <h4 class="box-title">Edit a Hari Besar
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    ...
                                    value="{{ old('title') ?? $haribesar->title }}" placeholder="Title" required>
                                </div>
                                @error('title')
                            ...
                            <div class="form-group">
                                <h5>Tema <span class="text-danger">*</span></h5>
                                <div class="controls">
                                    <input type="text" name="tema"
                                    class="form-control @error('tema') is-invalid @enderror"
                                    value="{{ old('tema') ?? $haribesar->tema }}" placeholder="Tema" required>
                                </div>
                                @error('tema')
                                <div class="form-control-feedback"><small> <code>{{ $message }}</code> </small></div>
                                @enderror
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    ...
                                    value="{{ old('date') ?? $haribesar->date }}" placeholder="Date" required>
                                </div>
                                @error('date')
                                <div class="form-control-feedback"><small> <code>{{ $message }}</code> </small></div>
                                @enderror
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group ">
                                    ...
                                    <input type="text" name="icon" class="form-control @error('icon') is-invalid @enderror" value="{{old('icon') ?? $haribesar->icon}}" placeholder="Icon" required autofocus>
                                </div>
                                <small>
                            ...
                            <div class="form-group">
                                ...
                                name="content">{{ old('content') ?? $haribesar->content }}</textarea>
                                @error('content')
                                <div class="form-control-feedback"><small> <code>{{ $message }}</code> </small></div>
                                @enderror
                            </div>
                            ...
                            <div class="form-group">
                                <div class=" fileinput fileinput-new" data-provides="fileinput">
                                    <div class="fileinput-new img-thumbnail" style="width: 200px;">
                                        <img src="{{ $haribesar->imageThumbUrl ? $haribesar->imageThumbUrl : '/assets/images/no_image.png' }}"
                                        alt="...">
                                    </div>
