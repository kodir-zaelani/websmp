...
<div class="content-header">
    <div class="d-flex align-items-center">
                    ...
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('backend.dashboard') }}"><i class="fa fa-home"><span
                            ...
                            <li class="breadcrumb-item" aria-current="page"><a
                                href="{{ route('backend.facility.index') }}">Facility</a></li>
        ...
        <section class="content">
            <form id="post-form" enctype="multipart/form-data" action="{{ route('backend.facility.store') }}" method="post">
                <div class="row">
                    @csrf
                    <div class="col-lg-8 col-12">
                        <div class="box">
                            <div class="box-header">
                                <h4 class="box-title">Create a Facility
                                </h4>
                            </div>
                            <div class="box-body">
                                ...
                                <div class="form-group @error('class') has-error @enderror">
                                    ...
                                    <select class="form-control select2" style="width: 100%;" name="class">
                                        ...
                                        <option value="primary" {{ old('class') == "primary" ? 'selected' : '' }}><span class="text-blue">Primary</span> </option>
                                        <option value="success" {{ old('class') == "success" ? 'selected' : '' }}><span class="text-green">Success</span> </option>
                                        <option value="warning" {{ old('class') == "warning" ? 'selected' : '' }}><span class="text-ornage">Warning</span> </option>
                                        <option value="info" {{ old('class') == "info" ? 'selected' : '' }}><span class="text-info">Info</span> </option>
                                        <option value="danger" {{ old('class') == "danger" ? 'selected' : '' }}><span class="text-red">Danger</span> </option>
                                    </select>
                                    @error('class')
