            ...
            <div class="d-inline-block align-items-center">
                <nav>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Edit a hero</li>
                    </ol>
                </nav>
            </div>
        </div>
...
<section class="content">
    <form id="post-form" enctype="multipart/form-data" action="{{ route('backend.heros.update', $hero->id) }}" method="post">
        <div class="row">
            @csrf
            @method('PUT')
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <div class="controls">
                                ...
                                value="{{ old('title', $hero->title) }}" placeholder="Title" required>
                            </div>
                            @error('title')
                        ...
                        <div class="form-group">
                            ...
                            <div class="controls">
                                ...
                                value="{{ old('student', $hero->student) }}" placeholder="Total Teacher" >
                            </div>
                            @error('student')
                            <div class="form-control-feedback"><small> <code>{{ $message }}</code> </small></div>
                            @enderror
                        ...
                        <div class="form-group">
                            ...
                            <div class="controls">
                                ...
                                value="{{ old('teacher', $hero->teacher) }}" placeholder="Total Teacher" >
                            </div>
                            @error('teacher')
                            <div class="form-control-feedback"><small> <code>{{ $message }}</code> </small></div>
                            @enderror
                        ...
                        <div class="form-group">
                            ...
                            <div class="controls">
                                ...
                                value="{{ old('administration', $hero->administration) }}" placeholder="Total Administrative Staff" >
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="controls">
                                ...
                                value="{{ old('ratio', $hero->ratio) }}" placeholder="Student - Teahcer Ratio" >
                            </div>
                            @error('ratio')
                            <div class="form-control-feedback"><small> <code>{{ $message }}</code> </small></div>
                            @enderror
                        ...
                        <div class="form-group @error('link_hero') has-error @enderror">
                            ...
                            <select class="form-control select2" style="width: 100%;" name="link_hero">
                                ...
                                <option value="{{ $item->slug }}"
                                    ...
                                    @if ($item->slug == $hero->link_hero) selected @endif>
                                    {{ $item->title }}
                                </option>
                                @endforeach
                            </select>
                        ...
                        <div class="row">
                            <div class="col-md-5 col-12">
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        ...
                                        value="{{ old('title_btn_link', $hero->title_btn_link) }}"
                            ...
                            <div class="col-md-7 col-12">
                                <div class="form-group">
                                    ...
                                    <div class="input-group ">
                                        ...
                                        <input type="text" name="icon_link" class="form-control @error('icon_link') is-invalid @enderror" value="{{old('icon_link') ?? $hero->icon_link}}" placeholder="Icon" required autofocus>
                                    </div>
                                    <small><a
                            ...
                            <div class="form-group">
                                ...
                                <div class="demo-radio-button">
                                    <input {{ $hero->target_link_hero == '_self' ? 'checked' : '' }} value="_self" name="target_link_hero"
                                    type="radio" id="radio_20"
                                    class="with-gap radio-col-success" />
                                    <label for="radio_20">Self</label>
                                    <input {{ $hero->target_link_hero == '_blank' ? 'checked' : '' }} value="_blank" name="target_link_hero"
                            ...
                            <div class="form-group">
                                ...
                                placeholder="Video"
                                value="{{ old('video_hero', $hero->video_hero) }}">
                                ...
                                <div class="col-md-5 col-12">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            ...
                                            value="{{ old('title_btn_video', $hero->title_btn_video) }}"
                                ...
                                <div class="col-md-7 col-12">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group ">
                                            ...
                                            <input type="text" name="icon_btn_video" class="form-control @error('icon_btn_video') is-invalid @enderror" value="{{old('icon_btn_video') ?? $hero->icon_btn_video}}" placeholder="Icon" required autofocus>
                                        </div>
                                        <small>
                            ...
                            <div class="form-group">
                                ...
                                name="description">{{ old('description', $hero->description) }}</textarea>
                                @error('description')
                                <div class="form-control-feedback"><small> <code>{{ $message }}</code> </small></div>
                                @enderror
                            </div>
                            ...
                            <div class="form-group">
                                <div class=" fileinput fileinput-new" data-provides="fileinput">
                                    <div class="fileinput-new img-thumbnail" style="width: 200px;">
                                        <img src="{{ $hero->imageheroThumbUrl ? $hero->imageheroThumbUrl : '/assets/images/no_image.png' }}" alt="...">
                                    </div>
